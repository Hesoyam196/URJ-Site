...
"<label>Аннотация:<br><textarea style=\"height: 120px;\" placeholder=\"Введите аннотацию...\" name=\"annotation"+String(curFieldNameId)+"\" id=\"annotation"+String(curFieldNameId)+"\"></textarea></label>"+
"<label>Цитирование:<br><textarea style=\"height: 120px;\" placeholder=\"Введите цитирование...\" name=\"citation"+String(curFieldNameId)+"\" id=\"citation"+String(curFieldNameId)+"\"></textarea></label>"+
...
"<label>Литература:<br><textarea style=\"height: 120px;\" placeholder=\"Введите литературу через перенос строки...\" name=\"literatures"+String(curFieldNameId)+"\" id=\"literatures"+String(curFieldNameId)+"\"></textarea></label>"+
