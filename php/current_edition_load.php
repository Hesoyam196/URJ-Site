...
<div class="current-edition">
        ...
        <div class="description">
          <h2>Содержание<a class="button-link" target="_blank" href="<?php echo $pdf_journal_path; ?>"">Читать выпуск</a><a class="button-link" href="<?php echo $pdf_journal_path; ?>"">Скачать выпуск</a></h2>
          <ul>
